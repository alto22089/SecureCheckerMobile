...
- 入力したURLやファイル情報は、サーバに一時保存され、第三者（VirusTotal, urlscan.io）に送信されるため、個人情報や機密情報を含むURL・ファイルの送信はお控えください。  
- また、アプリの機能はログイン中にのみ使用でき、30分で認証情報が失われるため、認証エラーが出た際は、ログイン画面に戻り、再度ログインをしてください。
